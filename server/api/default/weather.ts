...
export default defineEventHandler(async () => {
    ...
    try {
        ...
        const processedData = locations.map(
            (location: WeatherLocation): ProcessedWeatherData => {
                const wx = location.weatherElement.find(
                ...
                const pop = location.weatherElement.find(
