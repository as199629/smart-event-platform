        ...
        <div class="container mx-auto px-4 py-8">
            ...
            >
                ...
                <div>
                    ...
                    <input
                        ...
                        class="w-full px-4 py-2 border rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:text-gray-100"
                    />
                </div>
            ...
            >
                <div
                    ...
                    :key="event.id"
                    class="bg-white dark:bg-gray-700 shadow-lg rounded-lg overflow-hidden transition-transform duration-300 hover:scale-105"
                >
                    <!-- 活動圖片 -->
                    ...
                    <div class="p-4">
                        <!-- 活動名稱 -->
                        <h3
                            class="text-xl font-semibold mb-3 text-gray-800 dark:text-gray-100"
                        >
                            {{ event.name }}
                        </h3>
                        ...
                        <div class="space-y-2 mb-4">
                            <p
                                class="text-gray-600 dark:text-gray-100 text-sm flex items-center"
                            >
                                <Icon
